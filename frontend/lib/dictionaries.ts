...
const en = {
  ...
  "registerCase.descriptionPlaceholder":
    "Describe your situation — what happened, where, and who needs help",
  ...
  "registerCase.trappedDetailsPlaceholder":
    "Who is trapped, where exactly, and since when?",
  ...
  "registerCase.locationCaptured":
    "Location captured — the pin now marks your GPS position.",
  "registerCase.locationGeocoded":
    "Marked on the map from your description — drag the pin if it isn't exact.",
  ...
  "registerCase.tapMapHint":
    "Tap the map to drop or move the pin if it isn't exact.",
  ...
  "topBar.satelliteAnalysis": "Satellite analysis",
  ...
  "overview.priorityScore": "Priority score",
  "overview.aiScore": "AI Score",
  "overview.peopleAffected": "People Affected",
  "overview.trapped": "Trapped",
  "overview.none": "None",
  ...
  "checkIn.telemetryHint":
    "Live sensors aren't available in this browser — sample values are shown for this device.",
  "checkIn.thisDevice": "THIS DEVICE (YOU)",
  "checkIn.live": "Live",
  "checkIn.deviceCase": "Device / Case ID",
  "checkIn.battery": "Battery (%)",
  "checkIn.motionStatus": "Motion status",
  "checkIn.activeMoving": "Active / Moving",
  "checkIn.stationary": "Stationary",
  "checkIn.network": "Network / Signal",
  "checkIn.onlineDefault": "Online (4G)",
  "checkIn.onlineWithType": "Online ({type})",
  "checkIn.offline": "Offline",
  "checkIn.lastPing": "Last ping",
  "checkIn.escalation": "Escalation",
  "checkIn.ok": "OK",
  "checkIn.critical": "Critical / Unresponsive",
  ...
  "connect.aiConfidence": "AI Confidence",
  "connect.closeEvidence": "Close evidence details",
  ...
  "responseList.emptyHint":
    "New reports from the field will be ranked here automatically.",
  "responseList.reported": "Reported",
  "responseList.delete": "Delete",
  "responseList.deleting": "Deleting…",
  "responseList.deleteFailed":
    "Couldn't delete the case. Check your connection and try again.",

  // ----- Assistant -----
  "assistant.title": "Muhafiz AI Assistant",
  "assistant.noMessages": "No messages yet",
  "assistant.noMessagesHint":
    "Ask about active cases, trapped victims, or SOS volumes — or request a broadcast draft.",
  "assistant.suggestTrapped":
    "Show me all cases where people are trapped based on recent photos",
  "assistant.suggestBroadcast":
    "Draft an urgent evacuation alert for flood-prone zones",
  "assistant.suggestSummary":
    "Give me a 3-bullet executive summary of top emergency clusters",
  "assistant.suggestVisual":
    "What disaster types are most common in uploaded images?",
  ...
  "chat.quickFloodPrompt":
    "Flash flood water is rising near me. What should I do right now?",
...
const ur: Record<keyof typeof en, string> = {
  ...
  "signIn.error":
    "سائن ان نہیں ہو سکا۔ اپنا ای میل اور پاس ورڈ چیک کر کے دوبارہ کوشش کریں۔",
  ...
  "registerCase.descriptionPlaceholder":
    "اپنی صورتحال بیان کریں — کیا ہوا، کہاں ہوا، اور کسے مدد چاہیے",
  ...
  "registerCase.trappedDetailsPlaceholder":
    "کون پھنسا ہوا ہے، کہاں بالکل، اور کب سے؟",
  ...
  "registerCase.locationCaptured":
    "مقام حاصل ہو گیا — پن اب آپ کی جی پی ایس پوزیشن ظاہر کر رہا ہے۔",
  "registerCase.locationGeocoded":
    "آپ کی بتائی گئی جگہ نقشے پر نشان زد کر دی گئی — اگر پن بالکل درست نہ ہو تو اسے کھینچ کر درست کریں۔",
  "registerCase.locationError":
    "آپ کے مقام تک رسائی نہیں ہو سکی۔ براؤزر کی اجازتیں چیک کریں، یا نقشے پر ٹیپ کر کے پن خود رکھیں۔",
  "registerCase.tapMapHint":
    "اگر پن درست نہ ہو تو نقشے پر ٹیپ کر کے پن رکھیں یا ہٹائیں۔",
  ...
  "liveShare.cameraError":
    "کیمرے تک رسائی نہیں ہو سکی۔ اپنے براؤزر کی اجازتیں چیک کر کے دوبارہ کوشش کریں۔",
  ...
  "topBar.satelliteAnalysis": "سیٹلائٹ تجزیہ",
  ...
  "overview.priorityScore": "ترجیحی اسکور",
  "overview.aiScore": "اے آئی اسکور",
  "overview.peopleAffected": "متاثرہ افراد",
  "overview.trapped": "پھنسے ہوئے",
  ...
  "checkIn.telemetryHint":
    "اس براؤزر میں لائیو سینسر دستیاب نہیں — اس ڈیوائس کے لیے نمونہ اقدار دکھائی جا رہی ہیں۔",
  "checkIn.thisDevice": "یہ ڈیوائس (آپ)",
  "checkIn.live": "لائیو",
  "checkIn.deviceCase": "ڈیوائس / کیس آئی ڈی",
  "checkIn.battery": "بیٹری (%)",
  "checkIn.motionStatus": "حرکت کی حالت",
  "checkIn.activeMoving": "فعال / حرکت میں",
  "checkIn.stationary": "ساکن",
  "checkIn.network": "نیٹ ورک / سگنل",
  "checkIn.onlineDefault": "آن لائن (4G)",
  "checkIn.onlineWithType": "آن لائن ({type})",
  "checkIn.offline": "آف لائن",
  "checkIn.lastPing": "آخری پنگ",
  "checkIn.escalation": "ایسکلیشن",
  "checkIn.ok": "ٹھیک",
  "checkIn.critical": "انتہائی / بے خبر",
  ...
  "connect.cameraError":
    "کیمرے یا مائیکروفون تک رسائی نہیں ہو سکی۔ اپنے براؤزر کی اجازتیں چیک کر کے دوبارہ کوشش کریں۔",
  "connect.stopSharing": "شیئرنگ بند کریں",
  "connect.startSharing": "شیئرنگ شروع کریں",
  "connect.privacy":
    "شیئرنگ کب شروع ہو اور کب بند، یہ آپ طے کرتے ہیں۔ یہ کبھی خود بخود شروع نہیں ہوتی۔",
  ...
  "connect.aiConfidence": "اے آئی اعتماد",
  "connect.closeEvidence": "ثبوت کی تفصیلات بند کریں",
  ...
  "responseList.emptyHint":
    "فیلڈ کی نئی رپورٹس خودکار طور پر یہاں ترتیب دی جائیں گی۔",
  "responseList.reported": "رپورٹ کا وقت",
  "responseList.delete": "حذف کریں",
  "responseList.deleting": "حذف ہو رہا ہے…",
  "responseList.deleteFailed":
    "کیس حذف نہیں ہو سکا۔ اپنا کنکشن چیک کر کے دوبارہ کوشش کریں۔",

  // ----- Assistant -----
  "assistant.title": "محافظ اے آئی اسسٹنٹ",
  "assistant.noMessages": "ابھی کوئی پیغام نہیں",
  "assistant.noMessagesHint":
    "فعال کیسز، پھنسے ہوئے افراد یا SOS رپورٹس کے بارے میں پوچھیں — یا نشری الرٹ کا مسودہ تیار کروائیں۔",
  "assistant.suggestTrapped":
    "حالیہ تصاویر کی بنیاد پر تمام وہ کیسز دکھائیں جن میں لوگ پھنسے ہوئے ہیں",
  "assistant.suggestBroadcast":
    "سیلابی علاقوں کے لیے فوری انخلاء الرٹ کا مسودہ لکھیں",
  "assistant.suggestSummary": "اہم ایمرجنسی کلسٹرز کا 3 نکتوں میں خلاصہ دیں",
  "assistant.suggestVisual":
    "اپلوڈ کی گئی تصاویر میں کون سی آفت سب سے زیادہ عام ہے؟",
  "assistant.draftLoaded":
    "اے آئی کا مسودہ نیچے لود ہو گیا ہے — جائزہ لے کر بھیجیں۔",
  ...
  "chat.quickFloodPrompt":
    "میرے قریب اچانک سیلابی پانی بڑھ رہا ہے۔ میں ابھی کیا کروں؟",
